...
class AppTheme {
  ...
  static ThemeData light() {
    ...
    final base = _textTheme(colorScheme, Brightness.light);
    final body = GoogleFonts.interTextTheme(base);
    final headings = GoogleFonts.poppinsTextTheme(base);
    ...
    return ThemeData(
      ...
      filledButtonTheme: FilledButtonThemeData(
        style: ButtonStyle(
          minimumSize:
              const WidgetStatePropertyAll(Size.fromHeight(AppSpacing.xxxl)),
  ...
  static ThemeData dark() {
    ...
    final base = _textTheme(colorScheme, Brightness.dark);
    final body = GoogleFonts.interTextTheme(base);
    final headings = GoogleFonts.poppinsTextTheme(base);
    final textTheme = body.copyWith(
      displayLarge: headings.displayLarge,
  ...
  static ColorScheme _lightScheme() {
    return ColorScheme(
      ...
      secondary: AppPalette.secondary600,
      onSecondary: AppPalette.white,
      secondaryContainer: AppPalette.secondary500.withValues(alpha: 0.2),
      onSecondaryContainer: AppPalette.secondary700,
